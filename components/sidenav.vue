<template>
  <div
    class="dark flex-shrink-0 overflow-x-hidden bg-gray-50 border"
    style="width: 240px"
  >
    <div class="h-screen w-[240px]">
                      ...
                      <ol>
                        <li class="relative z-[15] h-auto">
                          ...
                          >
                            ...
                            <div
                              class="flex-1 text-ellipsis max-h-5 overflow-hidden break-all relative font-body"
                            >
...
<!-- <aside
  id="default-sidebar"
  class="float top-0 left-0 w-fit max-w-[290px] h-screen justify-start items-start border"
  aria-label="Sidebar"
>
  <div
    class="h-full px-3 py-4 overflow-y-auto bg-white flex flex-col gap-4 justify-between"
  >
    <div class="justify-between flex gap-2 w-fit">
      <NuxtLink to="#" class="btn-secondary">
        <svg
          width="20"
          height="20"
    ...
    <div
      class="h-full w-full p-3 bg-gray-50 rounded-lg flex flex-col justify-start items-start gap-4 inline-flex"
    >
      <div
        class="self-stretch justify-start items-center gap-2 inline-flex"
      >
        <div class="grow shrink basis-0 h-px bg-gray-200">
          <svg
            width="fill"
            height="2"
            viewBox="0 0 93 2"
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <rect x="0.5" y="0.5" width="92.5" height="1" fill="#EAECF0" />
          </svg>
        </div>
        <div
      ...
      <ul class="flex flex-col gap-4 font-body font-medium">
        <div
          class="m-2 justify-center items-center w-full max-w-max h-auto border rounded-lg gap-2 p-4 text-gray-700 whitespace-normal bg-white focus:text-primary-400 focus:bg-primary-50 focus:border-primary-400 box-border"
        >
          <li>
            <NuxtLink to="###">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Et
              itaque fuga amet consequuntur deleniti laudantium magnam
              officia suscipit est! Autem accusamus fugit neque repellat
              veniam accusantium sint blanditiis sunt quasi.
            </NuxtLink>
          </li>
        </div>
      </ul>
    </div>
    <div class="justify-center grid-col-last gap-2 w-fill">
      <NuxtLink to="#" class="btn-tertiary">
        <div class="w-5 h-5 relative">
          <svg
            width="20"
      ...
      <NuxtLink to="##" class="btn-tertiary">
        ...
        <div class="text-red-600 text-base font-semibold leading-normal">
          Log Out
        </div>
      </NuxtLink>
    </div>
